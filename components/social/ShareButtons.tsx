...
export default function ShareButtons({
  ...
  const shareLinks = {
    ...
    twitter: `https://twitter.com/intent/tweet?url=${encodedUrl}&text=${encodedTitle}${encodedHashtags ? `&hashtags=${encodedHashtags}` : ''}`,
        ...
        <>
          ...
          <div className="absolute right-0 mt-2 w-56 bg-white rounded-lg shadow-xl border border-gray-200 z-20 py-2">
            ...
            <button
              ...
              className="w-full px-4 py-2 text-left hover:bg-gray-50 transition-colors flex items-center gap-3 border-t border-gray-100"
            >
              <svg className="w-5 h-5 text-gray-600" fill="none" stroke="currentColor" viewBox="0 0 24 24">
